<html>
	...
	<body class="index">
		<div id="page-wrapper">
				...
				<div class="about-overlay">
					...
					<div class="inner">
						...
						<header>
							...
							<h2><span style="color: gold;">Love</span> what you drink.</h2>
						</header>
						<p>Meet who we are and learn what we <strong style="font-weight: 800;">drink.</strong></p>
						<footer>
			...
			<!-- Main -->
				<article id="main" style="background-color: gold;">

					<header class="special container" id="about" style="height: 1000px;">
						...
						<section class="wrapper style1 container special" >
							<div class="row" id="facts">
								<div class="4u 12u(narrower)">
									...
									<section>
										<img src="images/daniel.jpg" style="border-radius: 50%; height: 150px; margin: 0 auto">
										<header>
											<h3 style="color: black;"><b>Daniel Autry</b></h3>
											<h4 style="color: black; margin-top: -20px;">Development Lead</h4>
										</header>
										<p style="color: black;">Daniel joined the initiative as part of his quest to find the perfect drink for both body and mind. He loves our product, and thinks other people should too.</p>
									</section>
								...
								<div class="4u 12u(narrower)">
									...
									<section>
										<img src="images/pete.jpg"  style="border-radius: 50%; height: 150px; margin: 0 auto">
										<header>
											<h3 style="color: black;"><b>Pete Cybriwsky</b></h3>
											<h4 style="color: black; margin-top: -20px;">Design Lead</h4>
										</header>
										<p style="color: black;">Pete was exploring the arctic when some of the inhabitants invited him to try different glacial waters. Ever since, he's been trying to show the world what they're missing.</p>
									</section>
								...
								<div class="4u 12u(narrower)">
									...
									<section>
										<img src="images/tuz.jpg"  style="border-radius: 50%; height: 150px; margin: 0 auto;">
										<header>
											<h3 style="color: black;"><b>Nic Tuzinkiewicz</b></h3>
							...
							<div class="row" id="facts">
								...
								<div class="4u 12u(narrower)">
									...
									<section>
										...
										<p style="color: black;">Striaght from Torres del Paine in Patagonia, Torres is our northernmost drink. Its taste is unparalleled. Simply water at its finest.</p>
									</section>
